...
Bots = [mid,kimid,ki2mid,ki3mid,ki4mid,ki5mid,"u7972f3859b4ff0d7eb08812c59e3bc33"]
bot1 = cl.getProfile().mid
admsa = "u7972f3859b4ff0d7eb08812c59e3bc33"
admin = "u7972f3859b4ff0d7eb08812c59e3bc33"
...
def bot(op):
    ...
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "u7972f3859b4ff0d7eb08812c59e3bc33":
                    if "join:" in msg.text:
...
#------------------ KICK OUT FORM GROUP
        if op.type == 19:
            if op.param2 in bot1:
                return
            cl.sendText(op.param1,cl.getContact(op.param2).displayName + " ใจเย็น...ไอทิด")
              ...
              if msg.from_ in admin:
                ...
                if msg.toType == 2:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "==============================\nActive readers:%s\n\n\n\nPassive readers:\n%s\n\n==============================\nIn the last seen point:\n[%s]\n==============================\n Powered By:✬✬✬✬✬✬" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                        print "ReadPoint Set..."
                        try:
                            del wait2['readPoint'][msg.to]
                            del wait2['readMember'][msg.to]
