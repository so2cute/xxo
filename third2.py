...
║ ✯ ปิดลิ้ง  ➭  เปิดลิ้งกลุ่ม
║ ✯ ลิ้ง  ➭  เปิดและขอลิ้งกลุ่ม
╚════════════════════╝
╔════════════════════╗
║                            ᴄᴏᴘʏ ᴍɪᴍɪᴄ
╠════════════════════╝
║ ✯ Mycopy  ➭  ก๊อปปี้คนอื่น
║ ✯ Copy @  - คิกเกอร์1กอพปี้
║ ✯ Mybackup  ➭  คืนร่างเดิม
...
Bots = [mid,kimid,"ueacedbe88bf6e2c5cf6188b3a4a26e18"]
...
# ----------------- NOTIFED MEMBER OUT GROUP
        if op.type == 15:
            if op.param2 in bot1:
                return
            cl.sendText(op.param1,"ไปซะละ  " + cl.getContact(op.param2).displayName + "  แร้วเจอกัลใหม่นะ\n～(^з^)-♡")
              ...
              if msg.from_ in admin:
                ...
                if msg.toType == 2:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "==============================\nActive readers:%s\n\n\n\nPassive readers:\n%s\n\n==============================\nIn the last seen point:\n[%s]\n==============================\n Powered By:http://line.me/ti/p/4bvwOIMft8" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                        print "ReadPoint Set..."
                        try:
                            del wait2['readPoint'][msg.to]
                            del wait2['readMember'][msg.to]
